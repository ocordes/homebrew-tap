class Galsim15 < Formula
  desc "The modular galaxy image simulation toolkit"
  homepage "https://github.com/GalSim-developers/GalSim"
  url "https://github.com/GalSim-developers/GalSim/archive/v1.5.0-alpha.tar.gz"
  sha256 "26fe121f6eead974a9b3df01392810a0bb0889731b09aee946aaa3bc760d5b88"
  revision 1
  ...
  def install
    ...
    scons "DYLD_LIBRARY_PATH=$DYLD_LIBRARY_PATH", *args
